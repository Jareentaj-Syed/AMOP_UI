...
import { createModalData } from './customer_feature_codes_constants';
...
const CustomerFeatureCodes: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('/customer_feature_codes.xlsx');
  ...
  const handleExport = () => {
    ...
    XLSX.writeFile(workbook, "CustomerFeatureCodes.xlsx");
  };
...
export default CustomerFeatureCodes;
